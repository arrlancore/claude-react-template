...
export default function HeroSection() {
  ...
  const steps = [
    ...
    { left: 0, right: 4, sum: 12, message: "Move right: 1 + 11 = 12 (too low)" },
  ...
  return (
    <section className="mx-auto max-w-7xl py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-100 via-pink-50 to-purple-200 rounded-3xl">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
              Stop grinding LeetCode blindly. Learn the 8 essential algorithm patterns that unlock 90% of coding interviews.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
            <div className="text-center sm:text-left">
              ...
              <div className="text-sm text-muted-foreground">Interview Ready after Two Pointer</div>
            </div>
            <div className="text-center sm:text-left">
              <div className="text-2xl md:text-3xl font-bold text-primary">90%</div>
              <div className="text-sm text-muted-foreground">Problems solved with 8 patterns</div>
            </div>
            <div className="text-center sm:text-left">
              <div className="text-2xl md:text-3xl font-bold text-primary">6-8h</div>
              <div className="text-sm text-muted-foreground">vs weeks of grinding</div>
            </div>
          </div>
        </div>
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="relative h-full flex flex-col items-center justify-center p-8">
              ...
              <div className="text-center mb-8">
                <h3 className="text-xl font-bold text-white mb-2">Two Sum Problem</h3>
                <p className="text-purple-200 text-sm">Find two numbers that sum to {target}</p>
              </div>
              ...
              <div className="relative transform-gpu perspective-1000">
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          transform: isHighlighted ? 'rotateX(-10deg) rotateY(5deg) translateZ(20px)' : 'rotateX(0deg) rotateY(0deg) translateZ(0px)'
                        }}
                      >
                        {num}
                ...
                <div className="bg-black/20 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl">
                  <div className="text-center">
                    <div className="text-sm text-purple-200 mb-2">Current Sum</div>
                    <div className="text-2xl font-bold text-white">
                      {array[currentData.left]} + {array[currentData.right]} =
                      <span className={`ml-1 ${currentData.sum === target ? 'text-green-400' : 'text-orange-400'}`}>
                        {currentData.sum}
                      </span>
                    </div>
                    <div className={`text-sm mt-2 ${currentData.sum === target ? 'text-green-400' : 'text-orange-400'}`}>
                      {currentData.message}
                    </div>
                  </div>
                </div>
