...
export type PatternProgress = Database['public']['Tables']['pattern_progress']['Row']
...
export type MonthlyAIUsage = Database['public']['Views']['monthly_ai_usage']['Row']

// Learning specific types
export type LearningStage = 'introduction' | 'knowledge_check' | 'hands_on_practice' | 'mastery_assessment'
